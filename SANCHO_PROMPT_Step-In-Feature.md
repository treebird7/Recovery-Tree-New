...
**Timeline:** Base page structure first, question logic after database upload  
...
**Page Name:** "Step In"  
**Sub-header:** "12 Steps Journal and Questionnaire"  
**Theme:** Dark background (match URG mining color schema exactly)  
**Screen Type:** Full-screen immersive experience  
**Navigation:** Replace existing "Start New Walk" route completely
